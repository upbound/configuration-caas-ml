...
${KUBECTL} wait configuration.pkg configuration-caas-ml --for=condition=Installed --timeout 10m
echo "Waiting until configuration package is healthy..."
${KUBECTL} wait configuration.pkg configuration-caas-ml --for=condition=Healthy --timeout 10m
